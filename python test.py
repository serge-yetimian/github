...
class RecipeApp:
    ...
    def run_search_query(self):
        ...
        # Get the sorted recipes (You can choose sorting criteria like "readyInMinutes" or "servings")
        sorted_recipes = self.get_sorted_recipes_from_csv(query, sort_by=sort_method)
    ...
    def get_sorted_recipes_from_csv(self, query, sort_by="title"):
        try:
            ...
            print(f"Recipes matching query '{query}': {recipes}")  # Debug: check matching recipes
